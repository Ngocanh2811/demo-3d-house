        ...
        <div style={{ flex: 1, overflowY: "auto", fontSize: "13px" }}>
          {chatList.map((msg, i) => (
             <div key={i} style={{ marginBottom: "8px", textAlign: msg.id === socket.id ? "right" : "left" }}>
                ...
                <div style={{ background: msg.isPrivate ? "#fff3cd" : (msg.id === socket.id ? "#3498db" : (msg.role==='bot'?"#9b59b6":"#c08b1bff")), color: msg.id === socket.id ? "white" : "black", padding: "8px 12px", borderRadius: "12px", display: "inline-block", maxWidth: "85%", border: msg.isPrivate ? "1px solid #e67e22" : "none", textAlign: "left" }}>
